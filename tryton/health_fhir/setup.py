...
#    Copyright (C) 2011-2014 GNU Solidario
...
setup(name='trytond_health_fhir',
    version=info.get('version', '0.0.1'),
    description=info.get('description', 'GNU Health FHIR Module'),
    ...
    package_dir={'trytond.modules.health_fhir': '.'},
    packages=[
        'trytond.modules.health_fhir',
        'trytond.modules.health_fhir.report',
        'trytond.modules.health_fhir.tests',
        ],
    package_data={
        'trytond.modules.health_fhir': info.get('xml', []) \
    ...
    entry_points="""
    [trytond.modules]
    health_fhir = trytond.modules.health_fhir
    """,
    test_suite='tests',
