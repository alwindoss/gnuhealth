...
class Newborn(ModelSQL, ModelView):
    ...
    mother = fields.Many2One('medical.patient', 'Mother', select="1")
    ...
    apgar_scores = fields.One2Many('medical.neonatal.apgar', 'name',
        'APGAR scores')
    meconium = fields.Boolean('Meconium')
    congenital_diseases = fields.One2Many('medical.patient.disease',
    ...
    medication = fields.One2Many('medical.patient.medication',
        'newborn_id', 'Medication')
    responsible = fields.Many2One('medical.physician', 'Doctor in charge',
...
class PscEvaluation(ModelSQL, ModelView):
    ...
    psc = fields.One2Many('medical.patient.psc', 'name',
        'Pediatric Symptoms Checklist')
