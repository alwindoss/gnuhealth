...
class OperationalArea (ModelSQL, ModelView):
    ...
    operational_sector = fields.One2Many ('medical.operational_sector','operational_area',
...
class OperationalSector(ModelSQL, ModelView):
    ...
    operational_area = fields.Many2One('medical.operational_area',
...
class Family(ModelSQL, ModelView):
    ...
    members = fields.One2Many('medical.family_member', 'name',
        'Family Members')
...
class FamilyMember(ModelSQL, ModelView):
    ...
    name = fields.Many2One('medical.family', 'Family', required="1",
...
class PathologyCategory(ModelSQL, ModelView):
    ...
    parent = fields.Many2One('medical.pathology.category',
...
class Insurance(ModelSQL, ModelView):
    ...
    plan_id = fields.Many2One('medical.insurance.plan',
...
class Product(ModelSQL, ModelView):
    ...
    is_bed = fields.Boolean('Bed',
     help="Check if the product is a bed on the medical center")
...
# When the patient dies, it will show the age at time of death.
    ...
    family = fields.Many2One('medical.family',
    ...
    vaccinations = fields.One2Many('medical.vaccination',
        'name', "Vaccinations")
    medications = fields.One2Many('medical.patient.medication',
        'name', 'Medications')
    prescriptions = fields.One2Many('medical.prescription.order',
        'name', "Prescriptions")
    diseases = fields.One2Many('medical.patient.disease', 'name',
        'Diseases')
...
# Not used anymore . Now we relate with a shortcut. Clearer
    evaluation_ids = fields.One2Many('medical.patient.evaluation',
        'patient', 'Evaluation')
    admissions_ids = fields.One2Many('medical.patient.admission',
    ...
    def create(self, values):
        ...
        config_obj = self.pool.get('medical.sequences')
...
class PatientDiseaseInfo (ModelSQL, ModelView):
    ...
    pathology = fields.Many2One('medical.pathology', 'Disease',
...
class Appointment (ModelSQL, ModelView):
    ...
    speciality = fields.Many2One('medical.specialty', 'Specialty',
...
class PatientMedication(ModelSQL, ModelView):
    ...
    template = fields.Many2One('medical.medication.template',
        'Medication Template')
    name = fields.Many2One('medical.patient', 'Patient', readonly=True)
    doctor = fields.Many2One('medical.physician', 'Physician',
...
class PatientEvaluation(ModelSQL, ModelView):
    ...
    patient = fields.Many2One('medical.patient', 'Patient', select="1")
    evaluation_date = fields.Many2One('medical.appointment', 'Appointment', select="1", 
    ...
    derived_from = fields.Many2One('medical.physician', 'Derived from Doctor',
        help="Physician who escalated / derived the case")
    derived_to = fields.Many2One('medical.physician', 'Derived to Doctor',
    ...
    actions = fields.One2Many('medical.directions', 'name', 'P')
...
class HospitalWard(ModelSQL, ModelView):
    ...
    unit = fields.Many2One('medical.hospital.unit', 'Unit', select="2")
...
class HospitalBed(ModelSQL, ModelView):
    ...
    ward = fields.Many2One('medical.hospital.ward',
