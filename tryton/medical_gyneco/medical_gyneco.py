...
class Perinatal(ModelSQL, ModelView):
    ...
    monitoring = fields.One2Many('medical.perinatal.monitor', 'name',
        'Monitors')
    puerperium_monitor = fields.One2Many('medical.puerperium.monitor', 'name',
        'Puerperium monitor')
    medication = fields.One2Many('medical.patient.medication', 'name',
...
class MedicalPatient(ModelSQL, ModelView):
    'Add to the Medical patient_data class (medical.patient) the ' \
