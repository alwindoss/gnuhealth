...
# TO WORK WITH THE CLINICAL FINDINGS OF THE PATIENT
    ...
    cyanosis = fields.Boolean('Cyanosis',
        ...
        ' disease history. For example,  R23.0 in ICD-10 encoding')
    acropachy = fields.Boolean('Acropachy',
        help='Check if the patient shows acropachy / clubbing')
    nystagmus = fields.Boolean('Nystagmus',
        help='If associated  to a disease, please encode it on the patient'\
        ' disease history. For example,  H55 in ICD-10 encoding')
    miosis = fields.Boolean('Miosis',
        help='If associated  to a disease, please encode it on the patient'\
        ' disease history. For example,  H57.0 in ICD-10 encoding')
    ...
    arritmia = fields.Boolean('Arritmias',
        help='If associated  to a disease, please encode it on thepatient'\
        ' disease history')
    ...
    peau_dorange = fields.Boolean('Peau d orange',
        help='Check if the patient has prominent pores in the skin of the'\
        ' breast')
    gynecomastia = fields.Boolean('Gynecomastia')

    masses = fields.Boolean('Masses',
        help='Check when there are findings of masses / tumors / lumps')
    ...
    symptom_chest_pain_excercise = fields.Boolean('Chest Painon excercise'\
        ' only')
    symptom_orthostatic_hypotension = fields.Boolean('Orthostatic hypotension',
        help='If associated  to a disease,please encode it on the patient'\
        ' disease history. For example,  I95.1 in ICD-10 encoding')
