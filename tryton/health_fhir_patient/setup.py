...
setup(name='trytond_health_fhir_patient',
    ...
    package_dir={'trytond.modules.health_fhir_patient': '.'},
    packages=[
        'trytond.modules.health_fhir_patient',
        'trytond.modules.health_fhir_patient.report',
        'trytond.modules.health_fhir_patient.tests',
        ],
    package_data={
        'trytond.modules.health_fhir_patient': info.get('xml', []) \
    ...
    entry_points="""
    [trytond.modules]
    health_fhir_patient = trytond.modules.health_fhir_patient
    """,
    test_suite='tests',
