...
class DBLogin(object):
    def __init__(self):
        ...
        self.dialog = Gtk.Dialog(title="GNU Health HMIS - " + _('Login'), modal=True)
        ...
        tooltips.set_tip(button_cancel,
            _('Cancel connection to the GNU HEALTH HMIS server'))
        ...
        tooltips.set_tip(self.button_connect,
                         _('Connect the GNU Health HMIS server'))
